...
//         foreach (ProbeManager thisProbe in tpmanager.GetAllProbes())
//         {
...
//     {
//         SetRigCenter();
//         //tpmanager.GetActiveProbeController().MoveToAINDRigCoordinates(new RigCoordinates(apArcAngle, mlArcAngle,spin, manipulatorX, manipulatorY, manipulatorZ));
//     }
